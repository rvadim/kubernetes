...
// containerManagerImpl implements container manager on MacOS.
...
type noopMacOSResourceAllocator struct{}

func (ra *noopMacOSResourceAllocator) Admit(attrs *lifecycle.PodAdmitAttributes) lifecycle.PodAdmitResult {
...
func (cm *containerManagerImpl) Start(node *v1.Node,
	...
	klog.V(2).InfoS("Starting MacOS container manager")
...
func (cm *containerManagerImpl) GetAllocateResourcesPodAdmitHandler() lifecycle.PodAdmitHandler {
	return &noopMacOSResourceAllocator{}
}
